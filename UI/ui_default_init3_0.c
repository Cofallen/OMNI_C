...
void _ui_init_default_init3_0() {
    ...
    ui_default_init3_static31->start_x = 809;
    ui_default_init3_static31->start_y = 388;
    ui_default_init3_static31->end_x = 809;
    ui_default_init3_static31->end_y = 539;
    ui_default_init3_static31->color = 1;
    ui_default_init3_static31->width = 5;

    ui_default_init3_static32->figure_tpye = 0;
    ui_default_init3_static32->layer = 3;
    ui_default_init3_static32->start_x = 809;
    ui_default_init3_static32->start_y = 388;
    ui_default_init3_static32->end_x = 960;
    ui_default_init3_static32->end_y = 388;
    ui_default_init3_static32->color = 1;
    ui_default_init3_static32->width = 1;

    ui_default_init3_static33->figure_tpye = 0;
    ui_default_init3_static33->layer = 3;
    ui_default_init3_static33->start_x = 809;
    ui_default_init3_static33->start_y = 539;
    ui_default_init3_static33->end_x = 960;
    ui_default_init3_static33->end_y = 539;
    ui_default_init3_static33->color = 1;
    ui_default_init3_static33->width = 1;

    ui_default_init3_static34->figure_tpye = 0;
    ui_default_init3_static34->layer = 3;
    ui_default_init3_static34->start_x = 959;
    ui_default_init3_static34->start_y = 388;
    ui_default_init3_static34->end_x = 959;
    ui_default_init3_static34->end_y = 539;
    ui_default_init3_static34->color = 1;
